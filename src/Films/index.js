    ...
    return (
      <div>
        {this.props.data.map((item) => (
          <div className="film-details" key={item.name}>
            <div className="box-detail">
              <p className="title" id="best-rated-film">
                Best rated film
              </p>
              <p className="description">{item.name}</p>
            </div>
            <div className="box-detail">
              <p className="title" id="longest-film">
                Longest film duration
              </p>

              <p className="description">{item.length}</p>
            </div>
            <div className="box-detail">
              <p className="title" id="average-rating">
                Average rating
              </p>
              <p className="description">{item.rating}</p>
            </div>
            <div className="box-detail">
              <p className="title" id="shortest-days">
                Shortest days in release
              </p>
